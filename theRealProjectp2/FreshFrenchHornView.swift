...
struct FreshFrenchHornView: View {
           ...
           NavigationView {
               List {
                   ForEach(myList.items) { item in
                      ...
                      .navigationBarTitle(Text("Freshmen French Horn"))
...
struct FreshFrenchHornView_Previews: PreviewProvider {
