...
struct VPCalculatorView: View {
    ...
    var body: some View {
        ...
        HStack{
            ...
            HStack{
                List{Text(""); Text("Rhythm").font(.system(size: 12.0)); Text("Pitch").font(.system(size: 12.0)); Text("Tempo").font(.system(size: 12.0)); Text("Dynamic").font(.system(size: 11.5)); Text("Sound").font(.system(size: 12.0))}
            ...
            List{Text("Snare Etude").font(.system(size: 12.0)); TextField("/20", text: $serhythm); Text("n/a"); TextField("/20", text: $setempo); TextField("/20", text: $sedynamic); TextField("/20", text: $sesound)}
                
            List{Text("Mallet Etude").font(.system(size: 12.0)); TextField("/20", text: $merhythm); TextField("/20", text: $mepitch); TextField("/20", text: $metempo); TextField("/20", text: $medynamic); TextField("/20", text: $mesound);}
                
            List{Text("Timp Etude").font(.system(size: 12.0)); TextField("/20", text: $terhythm); Text("n/a"); TextField("/20", text: $tetempo); TextField("/20", text: $tedynamic); TextField("/20", text: $tesound);}
                
            List{Text("Snare Sight Read").font(.system(size: 12.0)); TextField("/20", text: $ssrrhythm); Text("n/a"); TextField("/20", text: $ssrtempo); TextField("/20", text: $ssrdynamic); TextField("/20", text: $ssrsound);}
                
            List{Text("Mallet Sight Read").font(.system(size: 12.0)); TextField("/20", text: $msrrhythm); TextField("/20", text: $msrpitch); TextField("/20", text: $msrtempo); Text("n/a"); TextField("/20", text: $msrsound);}
